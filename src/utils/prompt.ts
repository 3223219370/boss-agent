...
const OUTPUT_EXAMPLE = [
  ...
  '岗位：{"title":"Java后端工程师","salary":"30-50K","tags":["5-10年","本科"],"company":"某科技公司","location":"北京","description":"电商平台后端开发，要求熟悉微服务与分布式事务"}',
  '输出：{"match":true,"reason":"技能与经验高度匹配：Spring Cloud/MySQL/Redis/Kafka均为核心能力，8年经验满足5-10年要求，薪资合理","greeting":"您好，我有8年Java后端经验，深耕Spring Cloud微服务架构，主导过日活百万电商系统，期待与您进一步沟通"}',
].join('\n');
...
export function buildPrompt(resumeText: string, jobInfo: JobInfo): string {
  return [
    ...
    '4. 薪资与定位：以我简历中的水平看，该薪资区间对我是否合理（过高警惕虚假，过低不划算）',
    '5. 其他：工作地点、公司规模/行业、岗位职责是否符合我的职业规划',
    '',
    '判断标准：',
